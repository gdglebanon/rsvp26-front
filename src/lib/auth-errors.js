export function authErrorMessage(error) {
    const messages = {
        ...
        'auth/popup-blocked': 'Your browser blocked the sign-in window. Allow popups or use an email verification link.',
        ...
        'auth/invalid-credential': 'Verification could not be completed. Request a new email link and try again.',
        'auth/operation-not-allowed': 'Email verification is not enabled. Please contact the event team.',
